...
public:
  ...
  virtual Vector2S calculateResolution(const PlanetRenderContext* prc,
                                       const Tile* tile,
                                       const Sector& renderedSector) const = 0;
  
  virtual Sector getRenderedSectorForTile(const Tile* tile) const = 0;
